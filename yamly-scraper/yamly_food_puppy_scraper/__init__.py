...
def main(mytimer: func.TimerRequest) -> None:
    ...
    logging.info('Python recipe puppy timer trigger function ran at %s', utc_timestamp)
...
def get_food_puppy_data():
    engine = create_engine("mysql+pymysql://<CONNECTION >")
...
def get_nutrient_information(ingredient_name):
    ...
    headers = {}
    headers["Authorization"] = 'Token token="<FOOD REPO TOKEN>"'
...
def get_image_url(ingredient_name):
    ...
    headers = {}
    #headers["Authorization"] = "<PIXEL TOKEN>"
    headers["Ocp-Apim-Subscription-Key"] = "<BING URL>"
